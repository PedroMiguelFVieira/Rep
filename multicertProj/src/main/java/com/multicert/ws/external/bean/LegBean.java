...
public class LegBean {
	...
	private ManeuversBean maneuvers;
	...
	private String hasBridge;
	private String hasTunnel;
	...
	public ManeuversBean getManeuvers() {
		return maneuvers;
	}
	public void setManeuvers(ManeuversBean maneuvers) {
	...
	public String getHasBridge() {
		return hasBridge;
	}
	public void setHasBridge(String hasBridge) {
		this.hasBridge = hasBridge;
	}
	public String getHasTunnel() {
		return hasTunnel;
	}
	public void setHasTunnel(String hasTunnel) {
